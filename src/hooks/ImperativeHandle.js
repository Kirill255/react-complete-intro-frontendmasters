...
/*
здесь setState это ф-ция для обновления переменной state из хука const [state, setState] = useState("WA");
где state - это штат(а не состояние), оно просто так названо, не путать с state и setState из класс-компонента
*/
